...
export default function SettingsDemo() {
  ...
  const updateStorageInfo = () => {
    try {
      ...
      const chatsData = StorageService.loadChats()
      ...
      setStorageInfo({
        ...
        chats: `${(chatsSize / 1024).toFixed(2)} KB`,
    ...
    >
      <Space direction="vertical" size="middle" style={{ width: '100%' }}>
        ...
        <Row gutter={16}>
          ...
          <Col span={6}>
            <Statistic title="当前主题" value={settings.theme} />
          </Col>
          <Col span={6}>
        ...
        <Descriptions title="存储详情" size="small" column={2}>
          ...
          <Descriptions.Item label="聊天记录">
            <Badge status="processing" text={storageInfo.chats} />
          </Descriptions.Item>
